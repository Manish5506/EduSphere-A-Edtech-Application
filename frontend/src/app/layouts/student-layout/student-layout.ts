    ...
    <div class="d-flex min-vh-100 bg-dark text-light">
      ...
      <aside class="sidebar border-end border-secondary bg-dark-sidebar p-3 d-flex flex-column" style="width: 260px;">
        <div class="brand mb-4 pb-2 border-bottom border-secondary">
          ...
          <div class="small text-muted mt-1">Student Portal</div>
        </div>

        <ul class="nav flex-column gap-2 mb-auto">
          <li class="nav-item">
            <a routerLink="/student" class="nav-link text-light p-2 rounded hover-bg-secondary" routerLinkActive="bg-primary text-white">
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/courses" class="nav-link text-light p-2 rounded hover-bg-secondary">
              Browse Courses
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/student/my-courses" class="nav-link text-light p-2 rounded hover-bg-secondary" routerLinkActive="bg-primary text-white">
              My Learnings
            </a>
          </li>
          <li class="nav-item">
            <a routerLink="/student/certificates" class="nav-link text-light p-2 rounded hover-bg-secondary" routerLinkActive="bg-primary text-white">
              Certificates
            </a>
          </li>
        </ul>
